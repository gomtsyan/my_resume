...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | "theme": folder name for frontend part.
    | "admin_theme": folder name for backend views (Admin panel).
    | "admin_public": folder name for backend public (Admin panel).
    | "email_theme": folder name for email part.
    | "auth_theme": folder name for authentication.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Admin email to receive and send emails.
    |
    */

    'admin_mail' => env('ADMIN_MAIL', 'laratest@mailinator.com'),
    ...
    | Overall site color.
    |
    | Supported: "blue", "brown", "green", "orange", "purple", "red".
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | File folder names according to their types.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | When images are not selected the following pictures will be displayed.
    |
    */

    'comment_avatar' => 'comment_foto.png',

    'article_img' => 'post.png',

    'mini_logo_page' => 'blog.png',

    'admin_message_avatar' => 'businessman.png',

    'admin_new_message_avatar' => 'new.png',
    ...
    |--------------------------------------------------------------------------
    |
    | Folders for images of different pages.
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Count of display data from the database.
    |
    */
    ...
    'admin_latest_messages_count' => 3,

    'admin_messages_count' => 10,

    'admin_pages_count' => 10,

    'admin_portfolios_count' => 10,

    'admin_articles_count' => 10,

    'admin_visitors_count' => 10,
